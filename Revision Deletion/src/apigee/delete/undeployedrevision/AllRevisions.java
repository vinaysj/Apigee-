...
public class AllRevisions {
	...
	public static String[] listOfAllRevisions(Client client, String domainName, String orgName, String proxyName)
			throws Exception {
		...
		try {
			WebTarget target = client.target(
					"https://" + domainName + "/v1/organizations/" + orgName + "/apis/" + proxyName + "/revisions");
