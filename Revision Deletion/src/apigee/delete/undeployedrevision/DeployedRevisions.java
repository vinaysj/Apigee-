...
public class DeployedRevisions {
	...
	public static ArrayList<String> deployedRevision(Client client, String domainName, String orgName,
			String proxyName) {
		...
		WebTarget target1 = client.target(
				"https://" + domainName + "/v1/organizations/" + orgName + "/apis/" + proxyName + "/deployments");
